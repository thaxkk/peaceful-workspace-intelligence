...
# ดึงชื่อ Region ปัจจุบัน
data "aws_region" "current" {}

# ดึงรายชื่อ AZ ที่ใช้งานได้จริงใน Region นั้นๆ
data "aws_availability_zones" "available" {
  state = "available"
}

# ==========================================
# 1. ECR Repository (โกดังเก็บ Image)
# ==========================================
...
# ==========================================
# 2. Networking (VPC, Dynamic Subnets)
# ==========================================
...
# ==========================================
# 5. ECS Fargate Cluster & IAM Roles
# ==========================================
resource "aws_iam_role" "ecs_exec" {
  name = "${var.project_name}_exec_role"
...
# 🔥 จุดแก้ไข 1: เพิ่มสิทธิ์ให้คุยกับ SageMaker และ Bedrock
...
resource "aws_ecs_task_definition" "app" {
  ...
  container_definitions = jsonencode([{
    ...
    # 🔥 จุดแก้ไข 2: ยัดตัวแปร Environment ให้ Node.js อ่านได้
    environment = [
      { name = "SAGEMAKER_ENDPOINT_NAME", value = "polite-guard-endpoint" },
...
# 7. Outputs
# ==========================================
output "ecr_url" { value = aws_ecr_repository.api_repo.repository_url }
